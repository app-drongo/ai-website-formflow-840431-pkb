...
const DEFAULT_FOOTER = {
  logoText: 'FormFlow',
  companyDescription:
    'Streamline your form creation and data collection with our powerful, intuitive platform. Trusted by over 50,000 businesses worldwide to capture leads, gather feedback, and automate workflows.',
  contactEmail: 'support@formflow.com',
  contactPhone: '+1 (555) 347-8920',
  contactAddress: '2847 Innovation Drive, Suite 200, San Francisco, CA',
  newsletterTitle: 'Stay in the Flow',
  newsletterPlaceholder: 'Enter your email address',
  newsletterDisclaimer:
    'Get product updates, form building tips, and exclusive features. Unsubscribe anytime.',
  section1Title: 'Platform',
  section2Title: 'Company',
  section3Title: 'Support',
  section4Title: 'Legal',
  copyrightText: '© 2024 FormFlow. All rights reserved.',
  madeWithText: 'by the FormFlow team',
  socialText: 'Connect with us:',
  social1Href: 'https://twitter.com/formflow',
  social2Href: 'https://facebook.com/formflow',
  social3Href: 'https://instagram.com/formflow',
  social4Href: 'https://linkedin.com/company/formflow',
  social5Href: 'https://github.com/formflow',
} as const;
  ...
  const footerSections = [
    {
      ...
      links: [
        { name: 'Form Builder', href: '/form-builder', editableId: 'link-footer-form-builder' },
        ...
        { name: 'Workflows', href: '/workflows', editableId: 'link-footer-workflows' },
      ],
    },
    {
      title: config.section2Title,
      links: [
        { name: 'About FormFlow', href: '/about', editableId: 'link-footer-about' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Form Building Guide', href: '/guides', editableId: 'link-footer-guides' },
        ...
        { name: 'Migration Tool', href: '/migrate', editableId: 'link-footer-migrate' },
      ],
    },
    {
