...
const DEFAULT_HERO = {
  ...
  imageAlt: 'FormFlow dashboard interface',
  statsLabel1: 'Completion Rate',
  statsValue1: '87% average',
  statsLabel2: 'Setup Time',
  statsValue2: 'Under 5 min',
} as const;
...
export default function Hero(props: HeroProps) {
  ...
  return (
    <section id="hero" className="relative overflow-hidden bg-background">
      <div className="absolute inset-0 bg-gradient-to-br from-muted/20 via-transparent to-muted/30" />
      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          <div className="flex flex-col justify-center">
            <div className="mb-4 inline-flex w-fit items-center gap-2 rounded-full border border-foreground/20 bg-foreground/5 px-3 py-1.5 text-sm font-medium text-foreground">
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              <Button
                size="lg"
                className="group px-7 text-base bg-foreground text-background hover:bg-foreground/90"
              ...
              <Button
                size="lg"
                variant="outline"
                className="text-base border-muted hover:bg-muted/50"
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-2xl border border-muted bg-card shadow-2xl">
              ...
              <div className="absolute left-4 top-4 rounded-full bg-background/90 px-3 py-1 text-xs font-medium shadow border border-muted">
                <span data-editable="imageAlt">{config.imageAlt}</span>
              </div>
            </div>

            <div className="absolute -right-6 -top-6 hidden w-36 rounded-xl border border-muted bg-background/95 p-3 shadow-xl sm:block">
              <p className="text-xs text-muted-foreground" data-editable="statsLabel1">
                {config.statsLabel1}
              </p>
              <p className="text-sm">
                <span className="font-semibold text-foreground" data-editable="statsValue1">
                  {config.statsValue1}
                </span>
              </p>
            </div>
            <div className="absolute -left-6 -bottom-6 hidden w-36 rounded-xl border border-muted bg-background/95 p-3 shadow-xl sm:block">
              <p className="text-xs text-muted-foreground" data-editable="statsLabel2">
                {config.statsLabel2}
              </p>
              <p className="text-sm">
                <span className="font-semibold text-foreground" data-editable="statsValue2">
                  {config.statsValue2}
                </span>
              </p>
            </div>
