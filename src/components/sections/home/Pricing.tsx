...
const DEFAULT_PRICING = {
  ...
  mainDescription:
    'Start building beautiful forms for free. Upgrade when you need more power. No hidden fees, cancel anytime.',
  billingMonthly: 'Monthly',
  billingAnnual: 'Annual',
  billingAnnualBadge: 'Save 20%',
  plan1Name: 'Free',
  plan1Description: 'Perfect for getting started with form building',
  plan1Price: '$0',
  plan1CTA: 'Start Building',
  plan1CTAHref: '/signup',
  plan2Name: 'Pro',
  plan2Description: 'For businesses that need advanced features',
  plan2Price: '$25',
  plan2Period: '/month',
  ...
  plan3Name: 'Business',
  plan3Description: 'For teams and organizations with custom needs',
  plan3Price: '$99',
  plan3Badge: 'Advanced',
  ...
  bottomDescription:
    'We work with enterprises to create tailored form solutions that integrate seamlessly with your existing workflows and systems.',
...
export default function Pricing(props: PricingProps) {
  ...
  const plans = [
    ...
    },
    {
      ...
      price: billingCycle === 'annual' ? '$20' : config.plan2Price,
    ...
    },
    {
      ...
      price: billingCycle === 'annual' ? '$79' : config.plan3Price,
      period: config.plan2Period,
          ...
          {plans.map((plan, index) => (
            ...
            >
              ...
              <CardHeader className={cn('relative text-center pb-8', plan.popular && 'pt-10')}>
                ...
                {billingCycle === 'annual' && index > 0 && (
                  <p className="text-sm text-primary mt-2">
                    Save ${index === 1 ? '60' : '240'} per year
                  </p>
                )}
              </CardHeader>
