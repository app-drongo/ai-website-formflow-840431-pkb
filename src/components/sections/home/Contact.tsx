...
const DEFAULT_CONTACT = {
  badge: 'Get in Touch',
  mainTitle: 'Ready to Build Better',
  mainTitleHighlight: 'Forms?',
  mainDescription:
    "Have questions about FormFlow? Need help getting started? Our team is here to help you create engaging forms that convert. Reach out and we'll respond within 24 hours.",
  formTitle: 'Start the Conversation',
  formDescription:
    "Tell us about your form building needs and we'll show you how FormFlow can help.",
  submitButton: 'Send Message',
  contactSectionTitle: 'Contact Our Team',
  method1Title: 'Email Support',
  method1Description: 'Get detailed help via email',
  method1Contact: 'hello@formflow.com',
  method2Title: 'Sales Inquiries',
  method2Description: 'Speak with our sales team',
  method2Contact: '+1 (555) 123-FORM',
  ...
  office1Address: '123 Market Street, Suite 400',
  office1Timezone: 'PST (UTC-8)',
  office2City: 'New York',
  office2Address: '456 Broadway, Floor 12',
  office2Timezone: 'EST (UTC-5)',
  office3City: 'Austin',
  office3Address: '789 Congress Ave, Building C',
  ...
  supportNote: 'Priority support included with Pro and Business plans',
  nameLabel: 'Full Name *',
  ...
  messagePlaceholder:
    "Tell us about your form building needs, expected response volume, or any specific features you're looking for...",
} as const;
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 border border-border rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-foreground/20 focus:border-foreground transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full px-4 py-3 border border-border rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-foreground/20 focus:border-foreground transition-colors resize-none"
                ...
                <Button
                  type="submit"
                  className="w-full text-base py-6 group bg-foreground text-background hover:bg-foreground/90"
                >
              ...
              <div className="grid gap-4">
                {contactMethods.map((method, index) => {
                  ...
                  return (
                    <Card
                      key={index}
                      className="border-border/50 hover:border-foreground/20 transition-colors cursor-pointer group"
                    >
                      <CardContent className="p-6">
                        <div className="flex items-start gap-4">
                          <div className="size-12 rounded-lg bg-muted flex items-center justify-center group-hover:bg-muted/80 transition-colors">
